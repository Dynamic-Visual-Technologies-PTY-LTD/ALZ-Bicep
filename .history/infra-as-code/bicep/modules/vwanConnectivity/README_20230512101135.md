...
> - `privatelink.southafricanorth.backup.windowsazure.com`
> - `privatelink.southafricanorth.batch.azure.com`
...
| Output                | Type   | Example                                                                                                                                                                                                  |
| --------------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| outVirtualWanName     | string | alz-vwan-southafricanorth                                                                                                                                                                                          |
| outVirtualWanId       | string | /subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/alz-vwan-southafricanorth/providers/Microsoft.Network/virtualWans/alz-vwan-southafricanorth                                                               |
| outVirtualHubName     | string | alz-vhub-southafricanorth                                                                                                                                                                                          |
| outVirtualHubId       | string | /subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/alz-vwan-southafricanorth/providers/Microsoft.Network/virtualHubs/alz-vhub-southafricanorth                                                               |
| outDdosPlanResourceId | string | /subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/alz-vwan-southafricanorth/providers/Microsoft.Network/ddosProtectionPlans/alz-ddos-plan                                                         |
| outPrivateDnsZones    | array  | `["name": "privatelink.azurecr.io", "id": "/subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/net-lz-spk-southafricanorth-rg/providers/Microsoft.Network/privateDnsZones/privatelink.azurecr.io"]` |
