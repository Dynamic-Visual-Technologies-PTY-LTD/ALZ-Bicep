...
param parCompanyPrefix string = 'safps'
...
resource resVpnGateway 'Microsoft.Network/vpnGateways@2022-11-01' = [for (hub, i) in parVirtualWanHubs: if ((parVirtualHubEnabled) && (hub.parVpnGatewayEnabled)) {
  dependsOn: resVhub
...
resource resErGateway 'Microsoft.Network/expressRouteGateways@2022-11-01' = [for (hub, i) in parVirtualWanHubs: if ((parVirtualHubEnabled) && (hub.parExpressRouteGatewayEnabled)) {
  dependsOn: resVhub
