...
var varCustomPolicyDefinitionsArray = [
  ...
  {
    name: 'Deny-SqlInstancePools-Sku'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_Deny-SqlInstancePools-Sku.json')
  }
  {
    name: 'Deny-Synapse-Sql-Sku'
    libDefinition: loadJsonContent('lib/policy_definitions/policy_definition_es_Deny-Synapse-Sql-Sku.json')
  }
]
